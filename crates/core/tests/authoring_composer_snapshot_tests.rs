...
use visual_novel_engine::{
    authoring::{composer, AuthoringPosition, NodeGraph, StoryNode},
    runtime::{CharacterPlacementRaw, ChoiceOptionRaw, Engine},
    LocalizationCatalog, ResourceLimiter, SecurityPolicy,
};
...
fn presentation_snapshot_selected_authoring_overlay_wins_layer_provenance() {
    ...
    let runtime_script = crate::runtime::ScriptRaw::new(
        vec![crate::runtime::EventRaw::Choice(
            crate::runtime::ChoiceRaw {
