...
pub(super) fn render_player_menu_preview(
    ctx: &egui::Context,
    engine: &mut Engine,
...
fn render_preview_settings_tab(ui: &mut egui::Ui, player: &mut PlayerSessionState) {
    ...
    egui::ComboBox::from_id_source("player_menu_preview_skip_mode")
        .selected_text(match player.skip_mode {
            super::super::state::SkipMode::Off => "Skip: Off",
            super::super::state::SkipMode::ReadOnly => "Skip: Read",
            super::super::state::SkipMode::All => "Skip: All",
        })
        .show_ui(ui, |ui| {
            ui.selectable_value(
                &mut player.skip_mode,
                super::super::state::SkipMode::Off,
                "Skip: Off",
            );
            ui.selectable_value(
                &mut player.skip_mode,
                super::super::state::SkipMode::ReadOnly,
                "Skip: Read",
            );
            ui.selectable_value(
                &mut player.skip_mode,
                super::super::state::SkipMode::All,
                "Skip: All",
            );
        });
    ui.separator();
